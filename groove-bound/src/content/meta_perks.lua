...
return {
  ...
  live_wire = perk("live_wire", "Live Wire", 5, world_source("jazz", "C"),
    "Improvisation sharpens attack cooldown.",
    { key = "combat.cooldown_reduction", operation = "add", per_rank = 0.016, total_cap = 0.08 }),
  signal_boost = perk("signal_boost", "Blue Note Boost", 3, world_source("jazz", "A"),
    "Increase Resonance XP gain.",

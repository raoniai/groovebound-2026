...
```sh
python3 scripts/build_site_release.py --release v0.8.5
python3 scripts/setup_site_ftp_credentials.py --copy-existing
python3 scripts/publish_site.py --inspect-remote
python3 scripts/publish_site.py --release v0.8.5
python3 scripts/publish_site.py --release v0.8.5 --publish
python3 scripts/publish_site.py --release v0.8.5 --verify-public
```
